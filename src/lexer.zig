...
pub const Lexer = struct {
    ...
    pub fn currentCharacter(self: *Lexer) LexerError!u8 {
        if (self.cursor == self.source.len) {
            return ' '; // small hack to fix EOF handling
    ...
    fn collectRegister(self: *Lexer, character: u8) LexerError!void {
        switch (character) {
            'A'...'F', 'I' => {
                ...
                return LexerError.RegisterError;
            },
        }
    }
    ...
    fn collectInstruction(self: *Lexer, character: u8) LexerError!void {
        switch (character) {
            ...
            ' ', '\t', '\n', '\r' => {
                ...
                return LexerError.InstructionError;
            },
        }
    }
